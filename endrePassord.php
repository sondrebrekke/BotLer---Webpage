...
else if (mysqli_query($conn, "UPDATE lecturer SET password='$password' WHERE BINARY username= BINARY '$username'"))
{
        $melding = "You have successfully changed your password.";
}
else
{
    $melding = "You have not successfully changed password.";
}
