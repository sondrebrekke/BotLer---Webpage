<?php
    ...
    //If the add-assignment post isn't empty, it will trim and convert to utf8
	if(!empty($_POST)) 
	{			
		$name = $_POST['name']; 
...
<?php
    session_start();
    //redirects the user to index.html if a session isn't active
...
<html lang="en">
    <head>
        <!-- These following lines are for the styling of the webpage -->
        <meta charset="utf-8">
    ...
    <body>
        <div class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <!--Displays the logo and the menu-bar with links to the different sites -->
